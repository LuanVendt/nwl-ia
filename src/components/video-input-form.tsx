...
export function VideoInputForm(props: VideoInputFormProps) {
    ...
    async function handleUploadVIideo(event: FormEvent<HTMLFormElement>) {
    ...
    return (
            <form onSubmit={handleUploadVIideo} className="space-y-6">
                <label 
                htmlFor="video"
...
function userMemo(arg0: () => null | undefined, arg1: (File | null)[]) {
